...
contract SetupDistributionsLibTest is Test, TestConstants, SilvanaTaskManagerSetup {
    ...
    function setUp() public virtual override {
        ...
        ECDSAServiceManagerBase(silvanaDeployment.silvanaServiceManager).setRewardsInitiator(
            rewardsInitiator
        );
    ...
    function testCreateAVSRewardsSubmissions() public {
        ...
        mockToken.increaseAllowance(
            silvanaDeployment.silvanaServiceManager, amountPerPayment * numPayments
        );

        cheats.startPrank(rewardsInitiator);
        SetupDistributionsLib.createAVSRewardsSubmissions(
            address(silvanaDeployment.silvanaServiceManager),
            address(strategy),
            numPayments,
            amountPerPayment,
            duration,

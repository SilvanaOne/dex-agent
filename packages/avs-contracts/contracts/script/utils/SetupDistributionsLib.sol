...
library SetupDistributionsLib {
    ...
    function createAVSRewardsSubmissions(
        ...
        ECDSAServiceManagerBase(silvanaServiceManager).createAVSRewardsSubmission(
            rewardsSubmissions
        );
    }
    ...
    function createOperatorDirectedAVSRewardsSubmissions(
        ...
        ECDSAServiceManagerBase(silvanaServiceManager).createOperatorDirectedAVSRewardsSubmission(
            rewardsSubmissions
        );
    }
